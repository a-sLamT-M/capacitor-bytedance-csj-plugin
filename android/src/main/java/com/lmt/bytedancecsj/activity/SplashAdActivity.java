...
public final class SplashAdActivity extends Activity
{
    ...
    protected final void sendMessage(@NotNull String message, @NotNull JSObject obj) {
        ...
        BrowserService.INSTANCE.eventEmitter("splashAd", new EventMessage(message, obj));
    }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (var10001 == null) {
            ...
            this.mTTAdNative = var2.createAdNative(this);
    ...
    private final void loadSplashAd() {
        ...
        Point var3 = var10000.getScreenSize();
        Intrinsics.checkNotNullExpressionValue(var3, "BrowserService.INSTANCE.screenSize");
        Point displaySize = var3;
        AdSlot adSlot = (new AdSlot.Builder()).setCodeId(slotId)
            .setImageAcceptedSize(displaySize.x, displaySize.y)
            .setSupportDeepLink(true)
            .build();
        TTAdNative var4 = this.mTTAdNative;
        Intrinsics.checkNotNull(var4);
        var4.loadSplashAd(adSlot, (TTAdNative.CSJSplashAdListener)(new TTAdNative.CSJSplashAdListener() {
            public void onSplashLoadSuccess(@NotNull CSJSplashAd ad) {
                Intrinsics.checkNotNullParameter(ad, "ad");
                BrowserService.INSTANCE.eventEmitter("splashAdLoad", new EventMessage("loaded", (JSObject)null));
            }
                ...
                if (SplashAdActivity.this.mSplashContainer != null && !SplashAdActivity.this.isFinishing()) {
                    ...
                    ad.setSplashAdListener((CSJSplashAd.SplashAdListener)(new CSJSplashAd.SplashAdListener() {
                        public void onSplashAdShow(@Nullable CSJSplashAd p0) {
                            BrowserService.INSTANCE.eventEmitter("splashAdShow", new EventMessage("show", (JSObject)null));
                        }

                        public void onSplashAdClick(@Nullable CSJSplashAd p0) {
                            BrowserService.INSTANCE.eventEmitter("splashAdClick", new EventMessage("click", (JSObject)null));
                        }

                        public void onSplashAdClose(@Nullable CSJSplashAd p0, int p1) {
                            BrowserService.INSTANCE.eventEmitter("splashAdClose", new EventMessage("closing", (JSObject)null));
                            SplashAdActivity.this.finish();
                        }
                    }));
                } else {
